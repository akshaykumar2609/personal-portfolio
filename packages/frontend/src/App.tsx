    ...
    <div ref={containerRef} className="portfolio-wrapper">
      ...
      <header className="hero animate-fade-in">
        ...
        <div className="contact-bar">
          ...
          <a href="tel:+917901006141" className="contact-item" title="Call me">
          ...
          <a href="https://github.com/vakumullaakshaykumar" target="_blank" rel="noreferrer" className="contact-item" title="GitHub Profile">
          ...
          <a href="https://linkedin.com/in/vakumullaakshaykumar" target="_blank" rel="noreferrer" className="contact-item" title="LinkedIn Profile">
